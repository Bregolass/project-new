...
declare const getCheckoutByCartId: (variables: QueryParams, fields?: string[], config?: ConfigType) => Promise<APIResponse<Checkout> | APIResponse<undefined>>;
export default getCheckoutByCartId;
export declare type QueryParams = {
    cartId: string;
};
export declare enum ResponseField {
    ABANDONED_CHECKOUT_FLOWS__AUTHORIZED_APP_ID = "abandonedCheckoutFlows.authorizedAppId",
    ...
    ABANDONED_CHECKOUT_FLOWS__MESSAGE_TYPE = "abandonedCheckoutFlows.messageType",
    ...
    ABANDONED_CHECKOUT_FLOWS__SMS_TRANSLATION_ID = "abandonedCheckoutFlows.smsTranslationId",
    ...
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__DELETED = "cart.items.variant.bundleProducts.deleted",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__DISCOUNT_PRICE = "cart.items.variant.bundleProducts.discountPrice",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__DISCOUNT_RATIO = "cart.items.variant.bundleProducts.discountRatio",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__FINAL_PRICE = "cart.items.variant.bundleProducts.finalPrice",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__ORDER = "cart.items.variant.bundleProducts.order",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__PRICE = "cart.items.variant.bundleProducts.price",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__QUANTITY = "cart.items.variant.bundleProducts.quantity",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__TAX_VALUE = "cart.items.variant.bundleProducts.taxValue",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__BARCODE_LIST = "cart.items.variant.bundleProducts.variant.barcodeList",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__BASE_UNIT__BASE_AMOUNT = "cart.items.variant.bundleProducts.variant.baseUnit.baseAmount",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__BASE_UNIT__TYPE = "cart.items.variant.bundleProducts.variant.baseUnit.type",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__BASE_UNIT__UNIT__ID = "cart.items.variant.bundleProducts.variant.baseUnit.unit.id",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__BASE_UNIT__UNIT__NAME = "cart.items.variant.bundleProducts.variant.baseUnit.unit.name",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__BRAND__ID = "cart.items.variant.bundleProducts.variant.brand.id",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__BRAND__NAME = "cart.items.variant.bundleProducts.variant.brand.name",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__CATEGORIES__CATEGORY_PATH__ID = "cart.items.variant.bundleProducts.variant.categories.categoryPath.id",
    ...
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__NAME = "cart.items.variant.bundleProducts.variant.name",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__PRICES__BUY_PRICE = "cart.items.variant.bundleProducts.variant.prices.buyPrice",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__PRICES__CURRENCY = "cart.items.variant.bundleProducts.variant.prices.currency",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__PRICES__CURRENCY_SYMBOL = "cart.items.variant.bundleProducts.variant.prices.currencySymbol",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__PRICES__DISCOUNT_PRICE = "cart.items.variant.bundleProducts.variant.prices.discountPrice",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__PRICES__PRICE_LIST_ID = "cart.items.variant.bundleProducts.variant.prices.priceListId",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__PRICES__SELL_PRICE = "cart.items.variant.bundleProducts.variant.prices.sellPrice",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__PRICES__UNIT_PRICE = "cart.items.variant.bundleProducts.variant.prices.unitPrice",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__PRODUCT_ID = "cart.items.variant.bundleProducts.variant.productId",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__SKU = "cart.items.variant.bundleProducts.variant.sku",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__SLUG = "cart.items.variant.bundleProducts.variant.slug",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__TAG_IDS = "cart.items.variant.bundleProducts.variant.tagIds",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__TAGS__ID = "cart.items.variant.bundleProducts.variant.tags.id",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__TAGS__NAME = "cart.items.variant.bundleProducts.variant.tags.name",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__TAX_VALUE = "cart.items.variant.bundleProducts.variant.taxValue",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__TYPE = "cart.items.variant.bundleProducts.variant.type",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__UNIT__AMOUNT = "cart.items.variant.bundleProducts.variant.unit.amount",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__UNIT__TYPE = "cart.items.variant.bundleProducts.variant.unit.type",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__VARIANT_VALUES__ORDER = "cart.items.variant.bundleProducts.variant.variantValues.order",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__VARIANT_VALUES__VARIANT_TYPE_ID = "cart.items.variant.bundleProducts.variant.variantValues.variantTypeId",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__VARIANT_VALUES__VARIANT_TYPE_NAME = "cart.items.variant.bundleProducts.variant.variantValues.variantTypeName",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__VARIANT_VALUES__VARIANT_VALUE_ID = "cart.items.variant.bundleProducts.variant.variantValues.variantValueId",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__VARIANT_VALUES__VARIANT_VALUE_NAME = "cart.items.variant.bundleProducts.variant.variantValues.variantValueName",
    CART__ITEMS__VARIANT__BUNDLE_PRODUCTS__VARIANT__WEIGHT = "cart.items.variant.bundleProducts.variant.weight",
    ...
    CART__ITEMS__VARIANT__TAGS__ID = "cart.items.variant.tags.id",
    CART__ITEMS__VARIANT__TAGS__NAME = "cart.items.variant.tags.name",
