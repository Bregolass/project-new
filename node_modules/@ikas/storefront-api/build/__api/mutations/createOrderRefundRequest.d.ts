...
declare const createOrderRefundRequest: (variables: QueryParams, fields?: string[], config?: ConfigType) => Promise<APIResponse<StorefrontOrder> | APIResponse<undefined>>;
...
export declare enum ResponseField {
    ...
    INVOICES__HAS_PDF = "invoices.hasPdf",
    INVOICES__ID = "invoices.id",
    INVOICES__INVOICE_DATA = "invoices.invoiceData",
